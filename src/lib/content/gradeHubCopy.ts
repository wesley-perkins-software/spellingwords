...
export const gradeHubCopy: Record<GradeCode, GradeHubCopy> = {
  ...
  "2": {
    ...
    guidanceBody:
      "Start with Core Spelling and work through the ten steps in order — each one builds on the last, and the vowel patterns come first because everything longer depends on them. Use Grade 2 High-Frequency Words alongside the route rather than after it; the seven sets are the words your child needs for everyday writing right now. Additional Practice is optional and can be used whenever a child wants something familiar.",
