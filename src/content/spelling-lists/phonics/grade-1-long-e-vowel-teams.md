---
id: grade-1-long-e-vowel-teams
urlSlug: 1st-grade-long-e-vowel-teams
title: "Long E Vowel Teams"
description: "A first-grade core spelling lesson on long e vowel teams."
shortAnswer: "This Grade 1 core unit teaches long e vowel teams with a focused word list, parent-friendly explanation, misconceptions, and curriculum navigation."
category: phonics
grade: "1"
difficulty: beginner
skillTags: ["grade-1-core", "long-e-vowel-teams"]
...
nextLists: ["grade-1-tch-dge-ending-rules"]
featured: false
readinessSignals:
  - "Are ready for a focused first-grade spelling lesson on long e vowel teams"
...
This lesson teaches **long e vowel teams** as part of the Grade 1 core spelling progression. Students learn that ee and ea commonly spell the long e sound.
...
The vowel teams ee and ea both often spell long e. Students practice reading and spelling the whole vowel team as one sound.

## The spelling rule or generalization

Use ee and ea as two-letter spellings for long e; the exact choice often comes from seeing and practicing the word.
...
- Read the word **see** and spell each sound or spelling part.
- I can use **tree** in a sentence.
- Find the spelling pattern in **seed**.
- Write **feet** and check it from left to right.
...
- **Related targeted practice:** EE and EA Words.
- **Previous lesson:** Long A & Long O Vowel Teams.
- **Next lesson:** Short Vowel Ending Rules: -tch and -dge.
