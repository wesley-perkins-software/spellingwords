...
| Suffix spelling changes | Grades 3/5 | Yes | `grade-3-doubling-final-consonants`, `grade-3-dropping-silent-e`, `grade-3-changing-y-to-i`, `grade-5-spelling-rules` | `suffix-spelling-changes` | none | Content exists; Grade 5 page role remains unresolved | Preserve existing metadata and resolve the Grade 5 page during the Grade curriculum editorial phase. | Grade Unit editorial phase. |
