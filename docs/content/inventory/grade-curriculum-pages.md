...
| Kindergarten Short U Words | kindergarten-short-u-words | kindergarten-short-u-words | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-short-u-words.md` | Complete (Kindergarten Core batch editorial audit; minor dialect and diagnostic improvements) |
| Kindergarten Short E Words | kindergarten-short-e-words | kindergarten-short-e-words | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-short-e-words.md` | Complete (Kindergarten Core batch editorial audit; minor practice and diagnostic improvements) |
| Mixed Vowel CVC Review | kindergarten-mixed-vowel-review | kindergarten-mixed-vowel-review | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-mixed-vowel-review.md` | Complete (Kindergarten Core batch editorial audit; no prose change required) |
| Consonant Digraphs | kindergarten-consonant-digraphs | kindergarten-consonant-digraphs | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-consonant-digraphs.md` | Complete (Kindergarten Core batch editorial audit; material concept, error, and sequence correction) |
...
| Title | id | urlSlug | Role | Status | Source file | Editorial status |
|---|---|---|---|---|---|---|
| 1st Grade Number Spelling Words 11–20 | grade-1-number-words-11-20 | grade-1-number-words-11-20 | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-number-words-11-20.md` | Complete — Grade 1 Themed Spelling Practice member batch |
| 1st Grade Days of the Week Spelling Words | grade-1-days-of-the-week | grade-1-days-of-the-week | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-days-of-the-week.md` | Complete — Grade 1 Themed Spelling Practice member batch |
