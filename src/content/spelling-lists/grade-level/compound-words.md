---
id: compound-words
urlSlug: compound-words
title: "Compound Words"
description: "Learn how two meaningful words build one compound, how the parts support spelling and meaning, and why a compound is more than an ordinary syllable split."
shortAnswer: "A compound word combines two words into one larger word with a connected meaning: sun + shine = sunshine and note + book = notebook. Recognizing both meaningful parts gives a learner a reliable way to spell many longer words."
contentRole: skill
category: grade-level
grade: "2"
difficulty: developing
skillTags: ["compound-words", "word-structure"]
tags: ["word-structure"]
order: 908
...
featured: false
faq:
  - question: "Are all compound words written as one word?"
    answer: "No. English also has compounds written with a space or hyphen. This beginning spelling Skill uses closed compounds such as notebook, where the two words are joined with no space."
  - question: "Is every two-syllable word a compound word?"
    answer: "No. A compound must contain two meaningful words. Sunset is sun + set, but rabbit cannot be divided into two smaller words that build its meaning."
words:
  - sunshine
  - backpack
  - notebook
...
|---|---|---|---|
| *sun* | *shine* | *sunshine* | light that comes from the sun |
| *note* | *book* | *notebook* | a book for notes |
| *snow* | *man* | *snowman* | a figure made from snow |
| *tooth* | *brush* | *toothbrush* | a brush used for teeth |
...
- Preserve both spellings at the join: *back + pack = backpack*.
- Write the closed compounds on this page with no space or hyphen.
- Do not split a longer word into arbitrary chunks and call the chunks compound parts.
...
|---|---|
| *rain + bow = rainbow* | *robot* has syllables, not two meaningful word parts |
| *week + end = weekend* | *winter* cannot be explained as two component words |
| *bed + room = bedroom* | *basket* is not *bas + ket* |
...
**Dropping a letter at the join.** Ask the learner to spell each smaller word independently, then place the intact spellings together.

**Finding two accidental strings rather than two words.** Require the learner to say what each proposed part means and how it helps form the whole.
...
3. Join the cards, read the compound, and explain the connected whole meaning.
4. Copy the closed compound while preserving both complete spellings.
5. Contrast it with a noncompound longer word and ask why only one contains two meaningful words.
