...
words:
  - "finally"
  - word: "probably"
    hint: "Heart part: the middle -a- is easy to drop when speaking quickly — say all three syllables while spelling."
  - word: "actually"
    hint: "Heart part: double l before -y."
  - word: "immediately"
    hint: "Heart part: double m."
  - "eventually"
  - "meanwhile"
  - "instead"
  - "otherwise"
