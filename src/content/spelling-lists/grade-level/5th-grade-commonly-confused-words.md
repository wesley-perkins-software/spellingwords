...
skillTags: ["grade-5", "homophones", "commonly-confused-words", "writing"]
tags: ["grade-5", "homophones", "commonly-confused-words", "writing", "word-choice"]
order: 9
estimatedDurationMinutes: 12
status: published
masteryThreshold: 90
sourceType: curated
relatedLists: ["grade-5-reading-writing-words", "grade-5-opinion-argument-words", "grade-5-spelling-rules"]
...
faq:
  ...
  - question: "How should students study this list?"
    answer: "Practice each word in a sentence that makes its meaning clear, then compare it with its partner. Sorting by meaning, part of speech, or example sentence is more useful than copying the words alone."
featured: false
words:
  - desert
  - dessert
