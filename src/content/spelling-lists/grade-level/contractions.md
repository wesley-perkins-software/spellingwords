---
id: contractions
urlSlug: contractions
title: "Contractions"
description: "Learn how two words contract into a shorter form, how an apostrophe marks omitted letters, and how to spell common regular patterns and won't."
shortAnswer: "A contraction is a shortened form of two words. An apostrophe marks where one or more letters have been omitted: do not → don't, I am → I'm, and she will → she'll. Expanding the contraction helps a learner place the apostrophe."
contentRole: skill
category: grade-level
grade: "2"
difficulty: developing
skillTags: ["contractions", "apostrophes"]
tags: ["word-study"]
order: 909
...
featured: false
faq:
  - question: "Why does won't not look like will not?"
    answer: "Won't is an irregular contraction of will not. Its first part changes as well as losing letters, so it is best learned as a common whole-word exception."
  - question: "Does every apostrophe make a contraction?"
    answer: "No. Apostrophes can also mark possession. Expanding a word into two words is a useful test for a contraction: it's expands to it is or it has, while the possessive its does not."
words:
  - "can't"
  - "don't"
  - "didn't"
...
|---|---|---|
| *do not* | the *o* in *not* | *don't* |
| *did not* | the *o* in *not* | *didn't* |
| *I am* | the *a* in *am* | *I'm* |
| *she is* | the *i* in *is* | *she's* |
| *I will* | *w-i* in *will* | *I'll* |
...
- Put the apostrophe at the omission point and keep the remaining letters in order.
...
**Putting the apostrophe at the word boundary.** In *do not → don't*, the apostrophe belongs between *n* and *t*, where the omitted *o* was—not between *do* and *not*.

**Confusing *it's* and *its*.** Substitute *it is* or *it has*. If neither works, the word is not the contraction *it's*.
...
3. Cross out those letters and write an apostrophe at the omission point.
4. Join the remaining letters and reread the sentence.
5. Reverse the process: give a contraction and have the learner expand it to check both spelling and meaning.
