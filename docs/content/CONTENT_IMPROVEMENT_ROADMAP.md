...
| Phase 1 — Skill-page content | 41 skill slots (40 live + 1 content-pending) | 0 | 38 (5 Short Vowels + 4 Consonant Digraphs + 2 Consonant Blends + 4 Silent E + 3 Common Spelling Patterns + 7 Vowel Teams (all live slots; IE and IGH Words remains content-pending) + 3 R-Controlled Vowels + 1 Multisyllabic Words + 6 Word Building and Endings + 2 Prefixes + 1 Greek and Latin Roots — eleven family batches drafted and self-reviewed; all 38 pending independent human sign-off before moving to Complete) | 2 (Homophones and Commonly Confused Words) | 1 (IE and IGH Words — content-pending) |
