...
- **High-Frequency Words gateways and member sets** — member-set editorial work is governed by `docs/content/CANONICAL_HIGH_FREQUENCY_WORD_SET_PAGE_STANDARD.md`; gateway transformation is deferred. Not altered or extended here.
