...
skillTags: ["plurals", "inflectional-endings", "s", "es"]
tags: ["word-study", "nouns"]
order: 913
...
featured: false
faq:
  - question: "Does every plural end in -s or -es?"
    answer: "No. This Skill covers regular plurals. Familiar irregular plurals such as children, mice, and feet must be learned separately, and words such as sheep can have the same singular and plural form."
  - question: "Why does bus become buses but book becomes books?"
    answer: "Bus ends in a hissing sound, so -es adds a separate syllable: bus-es. Book does not, so it simply adds -s: books."
words:
  - cats
  - dogs
  - books
...
| Singular noun | Change | Plural noun |
|---|---|---|
| *cat* | add *-s* | *cats* |
| *dog* | add *-s* | *dogs* |
| *book* | add *-s* | *books* |
...
Most regular nouns add *-s*. Add *-es* when the singular ends in a hissing or buzzing sound commonly spelled *s*, *x*, *z*, *sh*, or *ch*: *bus → buses*, *fox → foxes*, *buzz → buzzes*, *brush → brushes*, and *lunch → lunches*. The plural then has an extra spoken syllable: *box-es*, *dish-es*. A word whose final *ch* sounds like /k/, such as *stomach*, does not fit that sound condition and simply forms *stomachs*.
...
**Dropping part of the singular word.** In *brushes*, both *brush* and *-es* remain. Build the word from the two visible parts instead of spelling only from the final sound.
...
3. Ask whether the ending needs the extra syllable in *-es*.
4. Build the plural with a visible equation, such as *dish + es = dishes*.
5. Mix *-s* and *-es* examples and have the learner explain each choice before spelling it.
