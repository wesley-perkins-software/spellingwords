...
| Skill id | Title | urlSlug | Grade (frontmatter) | Source file | Editorial status | Instructional variant | Content brief status |
|---|---|---|---|---|---|---|---|
| silent-e-long-a | Long A Silent E Words | silent-e-long-a | 1 | `src/content/spelling-lists/phonics/silent-e-long-a.md` | Not audited | 1 | Not started |
| silent-e-long-i | Long I Silent E Words | silent-e-long-i | 1 | `src/content/spelling-lists/phonics/silent-e-long-i.md` | Not audited | 1 | Not started |
| silent-e-long-o | Long O Silent E Words | silent-e-long-o | 1 | `src/content/spelling-lists/phonics/silent-e-long-o.md` | Not audited | 1 | Not started |
| silent-e-long-u | Long U Silent E Words | silent-e-long-u | 1 | `src/content/spelling-lists/phonics/silent-e-long-u.md` | Not audited | 1 | Not started |

## Vowel Teams

| Skill id | Title | urlSlug | Grade (frontmatter) | Source file | Editorial status | Instructional variant | Content brief status |
|---|---|---|---|---|---|---|---|
| vowel-teams-ai-ay | AI and AY Words | vowel-teams-ai-ay | 1 | `src/content/spelling-lists/phonics/vowel-teams-ai-ay.md` | Not audited | 1 | Not started |
| vowel-teams-ee-ea | EE and EA Words | vowel-teams-ee-ea | 1 | `src/content/spelling-lists/phonics/vowel-teams-ee-ea.md` | Not audited | 1 | Not started |
| vowel-teams-oa-ow | OA and OW Words | vowel-teams-oa-ow | 1 | `src/content/spelling-lists/phonics/vowel-teams-oa-ow.md` | Not audited | 1 | Not started |
| oi-and-oy-words | OI and OY Words | oi-and-oy-words | 2 | `src/content/spelling-lists/phonics/oi-and-oy-words.md` | Not audited | 1 | Not started |
| ou-and-ow-words | OU and OW Words | ou-and-ow-words | 2 | `src/content/spelling-lists/phonics/ou-and-ow-words.md` | Not audited | 1 | Not started |
| oo-words | OO Words | oo-words | 2 | `src/content/spelling-lists/phonics/oo-words.md` | Not audited | 1 | Not started |
| au-and-aw-words | AU and AW Words | au-and-aw-words | 2 | `src/content/spelling-lists/phonics/au-and-aw-words.md` | Not audited | 1 | Not started |
...
| Skill id | Title | urlSlug | Grade (frontmatter) | Source file | Editorial status | Instructional variant | Content brief status |
|---|---|---|---|---|---|---|---|
| r-controlled-ar | R-Controlled AR Words | r-controlled-ar | 1 | `src/content/spelling-lists/phonics/r-controlled-ar.md` | Not audited | 1 | Not started |
| r-controlled-or | R-Controlled OR Words | r-controlled-or | 1 | `src/content/spelling-lists/phonics/r-controlled-or.md` | Not audited | 1 | Not started |
| r-controlled-er-ir-ur | R-Controlled ER, IR, and UR Words | r-controlled-er-ir-ur | 1 | `src/content/spelling-lists/phonics/r-controlled-er-ir-ur.md` | Not audited | 1 | Not started |
...
**Resolved:** `silent-e-long-e` (Long E Silent E Words) was the third row in this table; it is now resolved per `docs/architecture/SKILLS_ARCHITECTURE.md` §5 — merged into the Silent E family overview on the Skills Hub as a compact, labeled note (not a peer Skill page), `status: archived` so no standalone page is emitted, and its former URL (`/spelling-lists/phonics/silent-e-long-e`) permanently redirects (301) to `/spelling-lists/skills/#silent-e-family`. Moved to the "Archived-status pages" table in `deprecated-and-legacy-pages.md`.
