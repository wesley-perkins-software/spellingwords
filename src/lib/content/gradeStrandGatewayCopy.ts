...
const grade1GatewayCopy: Record<GradeRouteClassification, GatewayCopyAuthor> = {
  ...
  'themed-spelling-practice': ({ memberCount }) => ({
    orientation: `These ${memberCount} optional 1st Grade spelling-practice lists use familiar themes and are not a sequence.`,
    synthesis:
