...
| Suffix spelling changes | Grades 3/5 | Yes | `grade-3-doubling-final-consonants`, `grade-3-dropping-silent-e`, `grade-3-changing-y-to-i`, `grade-5-spelling-rules` | `suffix-spelling-changes` | none | Grade 5 page resolved as grade-owned supporting curriculum content | Preserve its combined-entry relationship; audit its prose during the Grade 5 editorial pass. | Grade Unit editorial phase. |
