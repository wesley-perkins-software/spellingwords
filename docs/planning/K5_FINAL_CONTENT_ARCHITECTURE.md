...
The visible Grade 2 hub is implementation-complete with twenty-four cards: thirteen Core Spelling cards, six direct High-Frequency Words sets, and five Additional Practice cards. The `grade-2-common-words` collection remains the explanatory gateway while the hub exposes its six children directly.
...
| 1–6 | High-Frequency Words | **Grade 2 Common Words 1–6** | Direct canonical sets: `grade-2-common-words-1` through `-6` | Implemented | Practice 72 Grade 2 writing words. |
...
The visible Grade 3 hub is implementation-complete. It has sixteen cards: seven Core Spelling cards, five direct High-Frequency Words set cards, and four Additional Practice cards. The `grade-3-common-words` collection remains the canonical explanatory gateway, but the hub exposes its five children directly, matching the Kindergarten, Grade 1, and Grade 2 convention. See the Grade 3 Additional Practice subsection below for the full record.
...
The visible Grade 4 hub is implementation-complete. Core Spelling has six cards. High-Frequency Words has four direct numbered sets (48 words); the `grade-4-common-words` gateway remains the canonical explanatory landing page. Additional Practice has four cards: Measurement Words, Solar System Words, Career & Occupation Words, and Geometry Words. Executable route and Hub manifests are authoritative for current membership.
...
Four current cards are registered by the executable Hub manifest: **Measurement Words**, **Solar System Words**, **Career & Occupation Words**, and **Geometry Words**. The earlier one-card decision below is retained only as historical rationale for Measurement Words and does not define current membership. **Measurement Words** uses customary units only — `inch, foot, yard, mile, ounce, pound, ton, cup, pint, quart, gallon` (11 words). Tied to CCSS 4.MD.A.1 (the first point in the K–5 math sequence requiring students to know and convert measurement units), which no K–3 Additional Practice card touches. Verified zero overlap with Grade 4 Core Spelling, Common Words, or off-hub vocabulary; `cup` appears once, incidentally, in a Kindergarten CVC phonics example list, which is an allowed non-conflicting appearance under the same rule that governs incidental Common Words appearances.
...
Kindergarten, Grade 1, Grade 2, Grade 3, Grade 4, and Grade 5 now all realize the three-section architecture on their public hubs. Grade 3's Additional Practice section shipped in two passes: an initial review rejected three candidate topics and shipped zero cards, and a later pass under a broader philosophy approved and shipped four different topics — Map & Globe, Life Cycle, Time, and Multiplication & Division Words (Section 7). All six Common Words gateways and all twenty-nine K–5 child sets are published. Kindergarten exposes four sets and 40 words; Grade 1 and Grade 2 each expose six sets and 72 unique words; Grade 3 exposes five sets and 60 words; Grade 4 and Grade 5 each expose four sets and 48 words. The public hubs link directly to their set cards while their collection gateways remain canonical explanatory landing pages.
...
1. ~~Implement and validate Grade 2 Core Spelling and Common Words.~~ **Done.** The final corrective pass adds focused EE/EA, IE/IGH, and ER/IR/UR units, bringing Grade 2 to thirteen Core Spelling cards; see Section 6.
2. ~~Normalize Grade 3’s suffix-change and syllable-division route.~~ **Done.** Grade 3 shipped its full three-section hub: seven Core Spelling cards (including the merged Suffix Spelling Changes combined roadmap entry and the new Possessives page), five Common Words sets, and — after an initial reviewed-and-rejected pass, later revisited under a broader philosophy — four Additional Practice cards (Map & Globe, Life Cycle, Time, and Multiplication & Division Words) — see Section 7.
