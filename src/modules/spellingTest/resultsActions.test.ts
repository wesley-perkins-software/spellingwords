...
const coreSourceWithNext: PracticeSource = {
  ...
  grade: 'K',
  nextHref: '/grades/kindergarten/core-spelling/short-a-words',
...
const coreSourceAtGradeBoundary: PracticeSource = {
  type: 'core',
  title: 'Derived Words',
  href: '/grades/4th-grade/core-spelling/derived-words',
  grade: '4',
  nextHref: '/grades/5th-grade/core-spelling/multisyllabic-academic-words',
...
const coreSourceAtCurriculumEnd: PracticeSource = {
  ...
  href: '/grades/5th-grade/core-spelling/spelling-changes-related-words',
  grade: '5',
};
...
describe('resolveResultsActions', () => {
  it('perfect + source with nextHref: continueNext, retryFull, sourceReturn in order', () => {
    ...
    expect(actions[0].href).toBe('/grades/kindergarten/core-spelling/short-a-words');
    expect(actions[0].label).toBe('Continue to next unit →');
    expect(actions[2].href).toBe('/grades/kindergarten/core-spelling/first-words');
  });
