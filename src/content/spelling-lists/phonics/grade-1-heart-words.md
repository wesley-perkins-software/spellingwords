---
id: grade-1-heart-words
urlSlug: 1st-grade-heart-words
title: "First Grade Heart Words"
description: "A first-grade core spelling lesson on heart words."
shortAnswer: "This Grade 1 core unit teaches heart words with a focused word list, parent-friendly explanation, misconceptions, and curriculum navigation."
category: phonics
grade: "1"
difficulty: beginner
skillTags: ["grade-1-core", "heart-words"]
...
masteryThreshold: 90
sourceType: curated
relatedLists: ["grade-1-heart-words-part-1", "grade-1-heart-words-part-2", "grade-1-heart-words-part-3", "dolch-first-grade-a", "dolch-first-grade-b", "dolch-first-grade-c"]
prerequisiteLists: ["grade-1-open-syllables-final-y"]
nextLists: ["grade-1-inflectional-endings-s-es"]
featured: false
readinessSignals:
  - "Are ready for a focused first-grade spelling lesson on heart words"
...
This lesson teaches **heart words** as part of the Grade 1 core spelling progression. Students learn to map high-frequency words by identifying the regular parts and the parts that must be learned by heart.
...
Heart words are not simply memorized as whole shapes. Students say the word, map the sounds to letters, and mark the unexpected part.

## The spelling rule or generalization

Learn the regular sound-spellings first, then mark only the irregular or not-yet-taught part as the heart part.
...
- Read the word **said** and spell each sound or spelling part.
- I can use **was** in a sentence.
- Find the spelling pattern in **they**.
- Write **from** and check it from left to right.
...
- **Related targeted practice:** First Grade Heart Words Part 1, First Grade Heart Words Part 2, First Grade Heart Words Part 3, Dolch First Grade Sight Words — Part A, Dolch First Grade Sight Words — Part B, Dolch First Grade Sight Words — Part C.
- **Previous lesson:** Short Words with Long Vowels: Open Syllables & Final Y.
- **Next lesson:** Inflectional Endings: -s and -es.
