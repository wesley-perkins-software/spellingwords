...
| Kindergarten Short O Words | kindergarten-short-o-words | kindergarten-short-o-words | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-short-o-words.md` | Needs review (drafted and self-reviewed against `CANONICAL_GRADE_UNIT_PAGE_STANDARD.md` in the second Phase 2 pilot batch; independent human sign-off pending) |
| Kindergarten Short U Words | kindergarten-short-u-words | kindergarten-short-u-words | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-short-u-words.md` | Needs review (drafted and self-reviewed against `CANONICAL_GRADE_UNIT_PAGE_STANDARD.md` in the second Phase 2 pilot batch; independent human sign-off pending) |
| Kindergarten Short E Words | kindergarten-short-e-words | kindergarten-short-e-words | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-short-e-words.md` | Needs review (drafted and self-reviewed against `CANONICAL_GRADE_UNIT_PAGE_STANDARD.md` in the second Phase 2 pilot batch; independent human sign-off pending) |
| Mixed Vowel CVC Review | kindergarten-mixed-vowel-review | kindergarten-mixed-vowel-review | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-mixed-vowel-review.md` | Needs review (drafted and self-reviewed against `CANONICAL_GRADE_UNIT_PAGE_STANDARD.md` in the third Phase 2 Kindergarten batch; independent human sign-off pending) |
| Consonant Digraphs | kindergarten-consonant-digraphs | kindergarten-consonant-digraphs | grade-unit | published | `src/content/spelling-lists/phonics/kindergarten-consonant-digraphs.md` | Needs review (drafted and self-reviewed against `CANONICAL_GRADE_UNIT_PAGE_STANDARD.md` in the third Phase 2 Kindergarten batch; independent human sign-off pending) |
...
| Title | id | urlSlug | Role | Status | Source file | Editorial status |
|---|---|---|---|---|---|---|
| Grade 1 Number Words 11–20 | grade-1-number-words-11-20 | grade-1-number-words-11-20 | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-number-words-11-20.md` | Not audited |
| Grade 1 Days of the Week | grade-1-days-of-the-week | grade-1-days-of-the-week | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-days-of-the-week.md` | Not audited |
| Grade 1 Weather Words | grade-1-weather-words | grade-1-weather-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-weather-words.md` | Not audited |
| Grade 1 Clothing Words | grade-1-clothing-words | grade-1-clothing-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-clothing-words.md` | Not audited |
| Grade 1 Shape Words | grade-1-shape-words | grade-1-shape-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-1-shape-words.md` | Not audited |
...
| Grade 2 Transportation Words | grade-2-transportation-words | grade-2-transportation-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-2-transportation-words.md` | Not audited |
| Grade 2 Months of the Year | grade-2-months-of-the-year | grade-2-months-of-the-year | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-2-months-of-the-year.md` | Not audited |
| Grade 2 Money Words | grade-2-money-words | grade-2-money-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-2-money-words.md` | Not audited |
| Grade 2 Number Words 20–100 | grade-2-number-words-20-100 | grade-2-number-words-20-100 | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-2-number-words-20-100.md` | Not audited |
| Grade 2 Community Helpers | grade-2-community-helpers | grade-2-community-helpers | vocabulary-theme | published | `src/content/spelling-lists/grade-level/grade-2-community-helpers.md` | Not audited |
...
| Title | id | urlSlug | Role | Status | Source file | Editorial status |
|---|---|---|---|---|---|---|
| 3rd Grade Prefix Words | grade-3-prefix-words | 3rd-grade-prefix-words | grade-unit | published | `src/content/spelling-lists/grade-level/3rd-grade-prefix-words.md` | Not audited |
| 3rd Grade Suffix Words | grade-3-suffix-words | 3rd-grade-suffix-words | grade-unit | published | `src/content/spelling-lists/grade-level/3rd-grade-suffix-words.md` | Not audited |
| 3rd Grade Spelling Rule: Dropping Silent E | grade-3-dropping-silent-e | 3rd-grade-dropping-silent-e | grade-unit | published | `src/content/spelling-lists/grade-level/3rd-grade-dropping-silent-e.md` | Not audited |
| 3rd Grade Map & Globe Words | grade-3-map-globe-words | 3rd-grade-map-globe-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/3rd-grade-map-globe-words.md` | Not audited |
| 3rd Grade Possessive Words | grade-3-possessives | 3rd-grade-possessives | grade-unit | published | `src/content/spelling-lists/grade-level/3rd-grade-possessives.md` | Not audited |
| 3rd Grade Life Cycle Words | grade-3-life-cycle-words | 3rd-grade-life-cycle-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/3rd-grade-life-cycle-words.md` | Not audited |
| 3rd Grade Multisyllabic Words | grade-3-multisyllabic-words | 3rd-grade-multisyllabic-words | grade-unit | published | `src/content/spelling-lists/grade-level/3rd-grade-multisyllabic-words.md` | Not audited |
| 3rd Grade Homophones and Commonly Confused Words | grade-3-homophones | 3rd-grade-homophones | grade-unit | published | `src/content/spelling-lists/grade-level/3rd-grade-homophones.md` | Not audited |
| 3rd Grade Time Words | grade-3-time-words | 3rd-grade-time-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/3rd-grade-time-words.md` | Not audited |
| 3rd Grade Multiplication & Division Words | grade-3-multiplication-division-words | 3rd-grade-multiplication-division-words | vocabulary-theme | published | `src/content/spelling-lists/grade-level/3rd-grade-multiplication-division-words.md` | Not audited |
| 3rd Grade Root Word Families | grade-3-root-word-families | 3rd-grade-root-word-families | (untagged — confirmed canonical active via Grade Hub card, see untagged-and-data-quality.md) | published | `src/content/spelling-lists/grade-level/3rd-grade-root-word-families.md` | Not audited |
...
**Focused component page (not counted above):** `grade-4-final-stable-syllables` (4th Grade Final Stable Syllables: -ture and -sure, `src/content/spelling-lists/grade-level/4th-grade-final-stable-syllables.md`) realizes the -ture/-sure portion of the "Final Stable Syllables and Common Word Endings" canonical unit. It is not a separate Grade Hub card and not a separate frozen curriculum unit — it is reached only through `grade-4-advanced-suffixes`'s (the anchor page's) `relatedLists`/`nextLists` related-practice link, exactly as `K5_FINAL_CONTENT_ARCHITECTURE.md`'s Grade 4 implementation note describes. It is not a canonical Skill (see `skill-pages.md`). Its stored `contentRole: skill` is a documented legacy-role exception, not a Skill-taxonomy claim; final technical normalization of that field is deferred to the Grade 4 curriculum editorial pass. This does not change the Grade 4 Core Spelling card count (still 6) or the canonical-active page count above (still 10).
...
**Focused component page (not counted above):** `grade-5-spelling-rules` (5th Grade Spelling Rules, `src/content/spelling-lists/grade-level/5th-grade-spelling-rules.md`) teaches suffix-ending spelling disambiguation (-tion/-sion, -able/-ible, -ance/-ence) as part of the combined "Advanced Roots, Affixes, and Academic Words" canonical unit. It is not a separate Grade Hub card and not a separate frozen curriculum unit — it is reached only through `grade-5-prefix-suffix-words`'s (the anchor page's) `relatedLists`/`nextLists` related-practice link. It is not a canonical Skill (see `skill-pages.md`) and is not duplicative of `grade-5-spelling-changes-related-words`, `suffix-spelling-changes`, `common-suffixes`, or `common-prefixes` — each of those teaches a distinct sub-skill. Its stored `contentRole: skill` is a documented legacy-role exception, not a Skill-taxonomy claim; final technical normalization of that field is deferred to the Grade 5 curriculum editorial pass. This does not change the Grade 5 Core Spelling card count (still 5) or the canonical-active page count above (still 9).

---
**Total: 75 canonical-active Core Spelling / Additional Practice pages across K–5.** This counts pages that are their own Grade Hub card (a public curriculum-placement destination). It does **not** include `grade-4-final-stable-syllables` or `grade-5-spelling-rules` — those are published, grade-owned Grade curriculum *content* pages reachable via an existing combined unit's anchor page, not separate Hub cards or separate frozen curriculum units. Counting them: **75 public Grade Hub curriculum entries; 77 underlying published Grade curriculum content pages** (75 Hub-card pages + 2 focused component pages folded into existing combined units).


Pages that are grade-scoped in naming but not confirmed as part of the current architecture (not referenced by any Grade Hub card) are listed in `untagged-and-data-quality.md` as **unresolved**, not here. Pages matching `PUBLIC_URL_ARCHITECTURE.md`'s explicit legacy language (orphaned phonics focused-children, practice/review pages) are listed in `deprecated-and-legacy-pages.md`, not here. `grade-4-final-stable-syllables` and `grade-5-spelling-rules` are neither unresolved nor deprecated/legacy — see the focused-component-page notes above.
