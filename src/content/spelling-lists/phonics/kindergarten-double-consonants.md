...
faq:
  ...
  - question: 'Why is "off" the only -ff word in this list?'
    answer: 'It is the most common, kindergarten-familiar word that follows this exact pattern. Rather than reach for less familiar -ff words a five- or six-year-old would not recognize, this list keeps every word common and teacher-plausible, even if that means -ff appears only once.'
