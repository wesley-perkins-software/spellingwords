---
id: common-prefixes
urlSlug: common-prefixes
title: "Common Prefixes"
description: "Prefixes beyond un- and re- — pre-, dis-, mis-, inter-, sub-, super-, trans-, and anti- — including which ones attach to a whole base word and which attach to a Latin root instead."
shortAnswer: "This Skill practices common prefixes beyond un- and re-: pre- (\"before\"), dis- (\"not\"/\"opposite\"), mis- (\"wrongly\"), and the upper-elementary prefixes inter- (\"between\"), sub- (\"under\"), super- (\"above\"), trans- (\"across\"), and anti- (\"against\"). Some, like dis- and super-, attach to a whole base word; others, like pre- and trans- in this set, attach to a Latin root instead."
contentRole: skill
category: grade-level
grade: "3"
difficulty: intermediate
skillTags: ["prefixes", "morphology", "pre", "dis", "mis", "inter", "sub", "super", "trans", "anti"]
...
masteryThreshold: 90
sourceType: curated
relatedLists: ["greek-and-latin-roots"]
prerequisiteLists: ["un-and-re-prefixes"]
nextLists: []
featured: false
faq:
  - question: "Does this Skill cover every English prefix, such as non- or over-?"
    answer: "No. This page's demonstration set focuses on pre-, dis-, mis-, inter-, sub-, super-, trans-, and anti-. Other common prefixes, such as non- and over-, exist in English but aren't part of this specific word set."
  - question: "Is antifreeze written as one word?"
    answer: "Yes. Like most words built with a prefix, antifreeze is written as a single word with no space or hyphen."
words:
  - disagree
  - predict
  - misread
...
|---|---|---|---|
| *dis-* | not / the opposite of | *dis- + agree = disagree* | not in agreement |
| *mis-* | wrongly / badly | *mis- + read = misread* | to read incorrectly |
| *inter-* | between / among | *inter- + act = interact* | to act between or among others |
...
3. State the prefix's meaning and check it against the whole word.
