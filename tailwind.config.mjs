  ...
  theme: {
    extend: {
      colors: {
        ...
        // Real secondary grey — scoped to the role-aware detail pages so the
        // typographic hierarchy reads (the three ink tokens above are all pure
        // black). Warm grey to sit correctly on the paper/white surfaces.
        'ink-muted': '#5B5750',

        // Skill (concept-guide) role accent — a calm pine/sage editorial system
        // used only on Skill pages: section markers, definition rule, labels,
        // pull-quote, comparison headers. Kept as an accent, never a full wash.
        skill: {
          accent: '#2E6B57',
          'accent-deep': '#234F41',
          line: '#D2E3DA',
